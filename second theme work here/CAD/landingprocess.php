...
$apiResponse = $whatsapp_obj->sendText($country_code = '91', $to_mobile = $phone, $message = 'Thanks for your CAD course interest at TGC INDIA, Please let us know more about your learning requirements? ');


$toaddress='info@tgcindia.com,tgcanimation@gmail.com';
$subject1=' Inquiry from TGC  CAD Course Page ';  //changes for the heading subject
$mailcontent=' Email:'. $email .' Send you mail from CAD landing Course page' ." \n ".'Phone: '. $phone ." \n " .' name: '. $name ." \n ";  //content on mail here
