...
$apiResponse = $whatsapp_obj->sendText($country_code = '91', $to_mobile = $phone, $message = 'Thanks for your Graphic course interest at TGC INDIA, Please let us know more about your learning requirements? ');


$toaddress='info@tgcindia.com,tgcanimation@gmail.com';
$subject1=' Inquiry from TGC  Graphics Course Page ';  //changes for the heading subject
$mailcontent=' Email:'. $email .' Send you mail from Graphics landing Course page' ." \n ".'Phone: '. $phone ." \n " .' name: '. $name ." \n ";  //content on mail here
