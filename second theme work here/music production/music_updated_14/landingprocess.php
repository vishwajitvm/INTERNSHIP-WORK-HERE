...
$apiResponse = $whatsapp_obj->sendText($country_code = '91', $to_mobile = $phone, $message = 'Thanks for your course interest at TGC INDIA, Please let us know more about your learning requirements? Shivangi');


$toaddress='info@tgcindia.com,tgcanimation@gmail.com';
$subject1=' Inquiry from TGC  Music Production ';  //changes for the heading subject
$mailcontent=' Email:'. $email .' Send you mail from Music production' ." \n ".'Phone: '. $phone ." \n " .' name: '. $name ." \n ";  //content on mail here
