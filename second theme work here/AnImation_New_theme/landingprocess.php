...
$apiResponse = $whatsapp_obj->sendText($country_code = '91', $to_mobile = $phone, $message = 'Thanks for your Animation course interest at TGC INDIA, Please let us know more about your learning requirements? ');


$toaddress='info@tgcindia.com,tgcanimation@gmail.com';
$subject1=' Inquiry from TGC  Animation Course Page ';  //changes for the heading subject
$mailcontent=' Email:'. $email .' Send you mail from Animation landing Course page' ." \n ".'Phone: '. $phone ." \n " .' name: '. $name ." \n ";  //content on mail here
