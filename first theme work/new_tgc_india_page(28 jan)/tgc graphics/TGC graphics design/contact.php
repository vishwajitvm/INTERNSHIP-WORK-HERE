...
<head>
	...
	<meta name="description" content="TGC is a leading training Institute for Graphic Design, Web Design, 3D Animation & Multimedia B.Sc. degree & Diploma Courses.">
...
if(isset($_POST['email'])) { 
    ...
    $email_subject = "You've received a new message from TGC graphics design landing page"; 
    function died($error) {
        // Error message
  ...
  if(strlen($error_message) > 0) {
    ...
    $email_message = "Message details below from Graphics design PAge.\n\n";     
